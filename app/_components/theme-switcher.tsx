    ...
    <div style={{display: "flex", cursor: "pointer"}}>
      ...
      <div style={{cursor: "pointer", paddingRight: "10px"}} onClick={() => setTheme('dark')}>
        <button
          ...
          suppressHydrationWarning
          style={{all: "unset", display: "inline-block", borderRadius: "50%", cursor: "pointer", height: "24px", width: "24px", transition: "all 0.3s ease-in-out 0s", boxShadow: "calc(24px / 4) calc(24px / -4) calc(24px / 8)", inset: "#fff", backgroundColor: "transparent", border: "transparent", animation: "n linear 0.5s", rotate: "50deg" }}
        />
